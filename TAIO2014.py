#!/usr/bin/env python
"""
Main module for building classifier based on input arguments.
"""
import argparse
import sys
import random
...
if inputType == 'czyt':
    ...
    dataTrain = set_generator.generate_dataset(args.iloscPowtorzenWKlasie, representatives, (args.minLos, args.maxLos),
                                               args.zaburzenie)
...
if hasForeign:
    if not foreignTrain:
        ...
        foreignTrain = set_generator.generate_foreign_unified(trainAmount, representatives, (args.minLos, args.maxLos),
                                                              args.zaburzenie)
        foreignTest = set_generator.generate_foreign_unified(testAmount, representatives, (args.minLos, args.maxLos),
                                                             args.zaburzenie)
